...
- (void)viewDidLoad {
    ...
    Player* pique = [[Player new] init:@"Pique" withNumber:3 andCaptain:0 atPosition:@"DF"];
    Player* rakitic = [[Player new] init:@"Rakitic" withNumber:4 andCaptain:0 atPosition:@"MF"];
    Player* busquets = [[Player new] init:@"Busquets" withNumber:5 andCaptain:0 atPosition:@"MF"];
    Player* rodrigues = [[Player new] init:@"Rodrigues" withNumber:7 andCaptain:0 atPosition:@"FW"];
    Player* iniesta = [[Player new] init:@"Iniesta" withNumber:8 andCaptain:0 atPosition:@"MF"];
    Player* suarez = [[Player new] init:@"Suarez" withNumber:9 andCaptain:0 atPosition:@"FW"];
    Player* messi = [[Player new] init:@"Messi" withNumber:10 andCaptain:0 atPosition:@"FW"];
